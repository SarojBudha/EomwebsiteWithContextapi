...
const Nav = () => {
  ...
  const Nav = styled.nav`
    ...
    @media (max-width: ${({ theme }) => theme.media.mobile}) {
      ...
      /*when class active i.e  screen size is less than 768px(from app.js)*/
  ...
  return (
    <Nav>
      {/* ---if menuicon=true then its classname is navbar acttive else only "navbar" */}
      <div className={menuIcon ? "navbar active" : "navbar"}>
        ...
        {/* ----two button for open and close for responsive */}
